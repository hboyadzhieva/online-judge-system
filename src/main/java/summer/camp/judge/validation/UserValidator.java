...
/**
 * Class for validating {@link Testcase}
 */
@Singleton
public class UserValidator implements IValidator<User> {
	...
	@Override
	public boolean isValidCreate(User entity) {
		return haveAllProperties(entity);

	}

	@Override
	public boolean isValidUpdate(User entity) {
		return haveAllProperties(entity);
	}

	private boolean haveAllProperties(User entity) {
		/// TODO
